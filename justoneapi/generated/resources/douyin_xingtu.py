    ...
    def gw_api_gsearch_search_for_author_square_v1(
        ...
        *,
        ...
        Args:
            ...
            audience_image: Audience profile filter from Xingtu Audience Image. Pass one or more shortcut values or supported Chinese UI aliases separated by commas. Available values: - Gender: GENDER_MALE_50, GENDER_MALE_60, GENDER_MALE_70, GENDER_MALE_80, GENDER_FEMALE_50, GENDER_FEMALE_60, GENDER_FEMALE_70, GENDER_FEMALE_80; - Age: AGE_18_23, AGE_24_30, AGE_31_40, AGE_41_50, AGE_GT_50; - Device: DEVICE_IPHONE, DEVICE_HUAWEI, DEVICE_XIAOMI, DEVICE_VIVO, DEVICE_OPPO; - City tier: CITY_TIER_1, CITY_TIER_2, CITY_TIER_3, CITY_TIER_4, CITY_TIER_5; - Average order amount: SPEND_0_50, SPEND_50_100, SPEND_100_200, SPEND_200_500, SPEND_GT_500; - Crowd profile: CROWD_REFINED_MOTHER(53 精致妈妈), CROWD_URBAN_SILVER(54 都市银发), CROWD_NEW_WHITE_COLLAR(55 新锐白领), CROWD_SENIOR_MIDDLE_CLASS(56 资深中产), CROWD_URBAN_BLUE_COLLAR(57 都市蓝领), CROWD_GEN_Z(58 Z世代), CROWD_TOWN_MIDDLE_AGED(59 小镇中老年), CROWD_TOWN_YOUTH(60 小镇青年). Supported Chinese UI aliases: - Gender: 男性占比大于 or 女性占比大于 followed by 50%, 60%, 70%, or 80%; whitespace before the percentage number or percent sign is ignored; - Age: 18-23岁居多, 24-30岁居多, 31-40岁居多, 41-50岁居多, 大于50岁居多; - City tier: 一线城市居多, 二线城市居多, 三线城市居多, 四线城市居多, 五线城市居多. Example: GENDER_FEMALE_50,CROWD_REFINED_MOTHER
